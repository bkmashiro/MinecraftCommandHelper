...
namespace MinecraftCommandHelper
{
    ...
    /// 提供对于BlockGroup的管理服务
    /// </summary>
    public class BuildingBlockHostService
    {
        public BuildingBlockHostService(Canvas grid) { Holder = grid; }
        public Canvas Holder = null;

        public List<BuildingBlockGroup> BBGroups = new List<BuildingBlockGroup>();
    ...
    /// </summary>
    public class BuildingBlockGroup
    {
        public Point Position = new Point(0, 0);
        public Canvas Holder = null;
        public BuildingBlockHostService _service = null;
        public BuildingBlockGroup(BuildingBlockHostService service) { Holder = service.Holder; _service = service; service.BBGroups.Add(this); }
    ...
    public class BuildingBlock
    {
        ...
        public BuildingBlock Father_Node = null;
        public BuildingBlock Child_Node = null;
        int depth = -1;
        bool IsHead = false;
        public BuildingBlockGroup BuildingBlockGroup = null;
        public BBShapes HeadShape = BBShapes.None;
        public BBShapes TailShape = BBShapes.None;
        bool AutoSorption = true;
        bool SorptionSuccess = false;
        BuildingBlock SorptionTarget=null;
        string Hints = string.Empty;
        NBT BindingNBT = null;

        Canvas g = new Canvas();
        public BBCtrl bBCtrl;
        #endregion
