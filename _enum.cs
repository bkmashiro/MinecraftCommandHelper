   ...
   public class _Enums
    {
        ...
        public static string[] item_name_CN = {
                                                "空气",
                                                "TNT",
                                                "鞍",
                                                "白桦木楼梯",
        ...
        public static string[] hide_prop_cn = {
                                        "0 - 全部显示",
                                        "1 - 隐藏附魔",
                                        "2 - 隐藏自定义属性",
                                        "3 - 隐藏附魔和自定义属性",
        ...
        public static string[] hide_prop = {
                                        "0 - All Show",
                                        "1 - Hide Enchant",
                                        "2 - Hide Attribute",
        ...
        public static string[] entities_name = {
                            "Animal",
                            "Monster",
                            "Mob",
                            "Player",
        ...
        public static string[] entities_name_cn = {
                                    "动物",
                                    "怪物",
                                    "生物",
                                    "玩家",
        ...
        public static string[] entities_name_cn_v2 = {
            "玩家",
            "TNT",
            "豹猫",
            "北极熊",
        ...
        public static string[] effect_cn = {
                                "<清除效果>",
                                "饱和",
                                "凋零",
                                "发光",
        ...
        public static string[] effect_ID = { 
            "ERROR", "ERROR", "23", "3", "12", "11", "5", "22", "10", "21", "13", "6", "1", "8", "16", "14", "20", "9", "2", "17", "15", "7", "4", "18", "19"
        };
        ...
        public static string[] particle_En = {
                                "iconcrack - Eating, thrown eggs, splash potions, eyes of ender, breaking tools",
                                "blockcrack - Breaking blocks, sprinting, walking iron golems",
                                "blockdust - Breaking armor stands, falling",
                                "fallingdust - 	Unstable sand and gravel",
                                "explode - Explosions, mob death, mobs spawned by monster spawners, silverfish entering blocks",
                                "largeexplode - Explosions, ghast fireballs, wither skulls, Ender Dragon death, shearing mooshrooms",
                                "hugeexplosion - Explosions, Ender Dragon death",
                                "fireworksSpark - Firework rocket trail and explosion",
                                "bubble - Entities in water, guardian laser beams, fishing",
                                "splash - Entities in water, wolves after swimming, boats",
                                "wake - Fishing",
                                "suspended - Underwater",
                                "depthsuspend",
                                "crit - Critical hits, bows, evocation fangs",
                                "magicCrit - Sword or axe enchanted with Sharpness, Smite, or Bane of Arthropods",
                                "smoke - Torches, primed TNT, end portals, brewing stands, monster spawners, furnaces, ghast fireballs and more",
                                "largesmoke - Fire, Minecart with furnace, blazes, water flowing into lava",
                                "spell - Splash potions, lingering potions, bottles o' enchanting, evokers",
                                "instantSpell - Instant health/damage splash and lingering potions, spectral arrows",
                                "mobSpell - Status effects, lingering potions, tipped arrows, trading, wither armor",
                                ...
                                "happyVillager - Bone meal, trading with a villager, feeding a baby animal",
                                "townaura - Mycelium",
                                "note - Note blocks",
                                "portal - 	Nether portals, endermen, endermites, ender pearls, eyes of ender, ender chests, dragon eggs, eating chorus fruits, end gateway portals",
                                "enchantmenttable - Enchantment tables near bookshelves",
                                "flame - Torches, furnaces, Magma Cubes, monster spawners",
                                "lava - Lava",
                                "footstep",
                                "cloud",
                                "reddust - Redstone ore, powered redstone, redstone torches, powered redstone repeaters",
                                "snowballpoof - Thrown snowballs, creating withers, creating iron golems",
                                "snowshovel - Creating snow golems",
                                "slime - Slimes",
                                "heart - Breeding, taming",
                                "barrier - Barriers",
                                "droplet - Rain",
                                "take",
                                "mobappearance - Elder guardians",
                                "dragonbreath - Ender Dragon's breath, ender charges",
                                "endRod - End rods, shulker bullets",
                                "sweepAttack - When swords hit mobs",
                                "damageIndicator - Mobs when hurt by sword, axe or shovel",
                                "spit - Llamas spit",
                                "totem - Totem revive effect"
                               };

        public static string[] particle_Cn = {
        ...
        public static string[] firework_type_cn = {
                                    "小球状",
                                    "大球状",
                                    "星形状",
                                    "爬行者",
        ...
        public static string[] firework_type_en = {
                                    "Small Ball",
                                    "Big Ball",
                                    "Star",
                                    "Creeper",
        ...
        public static string[] sign_direction_cn = {
                                        "0 - 南",
                                        "1",
                                        "2 - 西南",
                                        "3",
        ...
        public static string[] sign_direction_en = {
                                        "0 - South",
                                        "1",
                                        "2 - SouthWest",
                                        "3",
        ...
        public static string[] colors_En = {
                                "black",
                                "gray",
                                "dark_gray",
                                "white",
        ...
        public static string[] colors_cn = {
                                    "黑色",
                                    "灰色",
                                    "深灰色",
                                    "白色",
        ...
        public static string[] villagerType_cn = {
                                    "棕色，村民",
                                    "棕色，农民",
                                    "棕色，渔夫",
                                    "棕色，牧羊人",
        ...
        public static string[] villagerType_En = {
                                    "Brown, Villager",
                                    "Brown, Farmer",
                                    "Brown, Fisherman",
                                    "Brown, Shepherd",
        ...
        public static int[,] villagerType = {
                                    { 0, 0 },
                                    { 0, 1 },
                                    { 0, 2 },
                                    { 0, 3 },
        ...
        public static string[] bannerColor_cn = {
                                    "黑色",
                                    "红色",
                                    "绿色",
                                    "棕色",
        ...
        public static string[] bannerColor_En = {
                                    "Black",
                                    "Red",
                                    "Green",
                                    "Brown",
        ...
        public static string[] bannerType_cn = {
                                                "中心圆形",
                                                "中心菱形",
                                                "竖条纹形",
                                                "自上渐淡",
        ...
        public static string[] bannerType_en = {
        ...
        public static byte[,] BannerColor_RGB = {
                                                {25,25,25},
                                                {153,51,51},
                                                {102,127,51},
                                                {102,76,51},
        ...
        public static string[] scoreStr1 = {
        ...
        public static string[] scoreStr2 = {
                                        "x",
                                        "y",
                                        "z",
                                        "dx",
        ...
        public static string[] scoreStr3 = {
                                        "/blockdata",
                                        "/testforblock",
                                        "/entitydata",
                                        "/testfor",
        ...
        public static string[] scoreStr4 = {
                                        "< 本例所为方块/实体数据的解析 >",
                                        "方块 - 头 | 玩家头 | IceLitty",
                                        "方块 - 花盆 | 带有茜草花",
                                        "方块 - 唱片机 | 带有自定义物品",
        ...
        public static string[] biomeId_limited = {
                                        "minecraft:ocean",
                                        "minecraft:plains",
                                        "minecraft:desert",
        ...
        public static string[] biomeStr_cn = {
                                        "<未加载>",
                                        "海洋",
                                        "草原",
                                        "沙漠",
        ...
        public static string[] biomeStr_En = {
                                        "<Unload>",
                                        "Ocean",
                                        "Plains",
                                        "Desert",
        ...
        public static string[] uniColor_cn = {
                                        "无",
                                        "黑色",
                                        "深蓝色",
                                        "深绿色",
        ...
        public static string[] uniColorStrEn = {
                                        "None",
                                        "Black",
                                        "Dark Blue",
                                        "Dark Green",
        ...
        public static string[] woolColor_cn = {
                                            "白色",
                                            "橙色",
                                            "紫红色",
                                            "亮蓝色",
        ...
        public static string[] woolColor_En = {
                                            "White",
                                            "Orange",
                                            "Magenta",
                                            "Light blue",
        ...
        public static string[] trigger_cn = {
            "玩家繁殖动物时",
            "从酿造台拿出酿好的药水时",
            "改变维度时",
            "改变信标时",
        ...
        public static string[] potionID_cn = {
            "水瓶",
            "平凡的药水",
            "浑浊的药水",
            "粗制的药水",
